...
export enum DICT_TYPE {
  ...
  // ========== CR 监管报送模块 ==========
  CR_REPORT_FREQ = 'cr_report_freq', // 报送数据频度
  CR_TASK_STATUS = 'cr_task_status', // 报表任务状态
  CR_FILL_STATUS = 'cr_fill_status', // 数据填报状态
  CR_CHECK_STATUS = 'cr_check_status', // 数据校验状态
  CR_ORG_LEVEL = 'cr_org_level', // 机构层级
  CR_REPORT_TYPE = 'cr_report_type', // 上报方式
  CR_ERROR_LEVEL = 'cr_error_level', // 错误级别
  CR_RULE_TYPE = 'cr_rule_type', // 校验规则类型
  CR_DESENSITIZE_TYPE = 'cr_desensitize_type', // 脱敏规则类型
  CR_AUDIT_STATUS = 'cr_audit_status', // 报送审核状态
  CR_MESSAGE_TYPE = 'cr_message_type', // 报文类型
  CR_CALIBER_TYPE = 'cr_caliber_type', // 口径类型
  CR_PERIOD_STATUS = 'cr_period_status', // 报送期次状态
  CR_COLLECT_CHANNEL = 'cr_collect_channel', // 数据采集方式
  CR_FILE_TYPE = 'cr_file_type', // 导入文件类型
  CR_IMPORT_STATUS = 'cr_import_status', // 导入任务状态
  CR_IMPORT_ACTION = 'cr_import_action', // 导入日志动作
  CR_SUPPLEMENT_STATUS = 'cr_supplement_status', // 补录状态
  CR_SUBJECT_TYPE = 'cr_subject_type', // 授权主体类型
  CR_ENABLE_STATUS = 'cr_enable_status', // 启停状态
  CR_DESENS_STATUS = 'cr_desens_status', // 脱敏执行状态
  CR_SPLIT_MODE = 'cr_split_mode', // 数据拆分方式
  CR_SPLIT_STATUS = 'cr_split_status', // 数据拆分批次状态
  CR_SCOPE_TYPE = 'cr_scope_type', // 机构数据范围类型
  CR_DEPT_ACTION = 'cr_dept_action', // 部门权限动作
  CR_TASK_IMPL_TYPE = 'cr_task_impl_type', // 任务实现类型
  CR_TASK_RUN_STATUS = 'cr_task_run_status', // 任务运行状态
  CR_CLUSTER_ROLE = 'cr_cluster_role', // 集群节点角色
  CR_CLUSTER_STATUS = 'cr_cluster_status', // 集群节点状态
  CR_FORMULA_TYPE = 'cr_formula_type', // 公式类型
